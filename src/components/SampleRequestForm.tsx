...
const labelsByLocale: Record<Locale, Labels> = {
  en: {
    ...
    successMessage: 'Our team will contact you within 24 hours to confirm sample details and next steps.',
  ...
  zh: {
    ...
    submitting: '提交中...',
    success: '申请已提交！',
    successMessage: '我们会在 24 小时内联系您，确认样品需求与下一步资料。',
    error: '提交失败',
    errorMessage: '请稍后再试。',
  },
  de: {
    ...
    successMessage: 'Unser Team meldet sich innerhalb von 24 Stunden, um Musterdetails und nächste Schritte zu bestätigen.',
  ...
  ja: {
    ...
    submitting: '送信中...',
    success: '依頼を送信しました！',
    successMessage: '24時間以内にご連絡し、サンプル条件と次のステップを確認します。',
    error: '送信失敗',
  ...
  es: {
    ...
    successMessage: 'Nuestro equipo le contactará en 24 horas para confirmar detalles de muestra y próximos pasos.',
    error: 'Envío fallido',
