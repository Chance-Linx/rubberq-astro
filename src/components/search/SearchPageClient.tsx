      ...
      <section className="relative bg-industrial-900 text-white py-24 overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <form onSubmit={handleSubmit} className="flex gap-2 max-w-xl mx-auto">
            ...
            />
            <button type="submit" className="bg-accent-orange text-white px-6 py-4 font-bold text-sm uppercase tracking-widest hover:bg-white hover:text-industrial-900 transition-all duration-300">
