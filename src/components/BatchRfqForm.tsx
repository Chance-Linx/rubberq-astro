...
const labelsByLocale: Record<Locale, Labels> = {
  en: {
    ...
    successMessage: 'Our team will contact you within 24 hours to confirm project details and next steps.',
  ...
  zh: {
    ...
    submitting: '提交中...',
    success: '批量询价已提交！',
    successMessage: '我们会在 24 小时内联系您，确认项目需求与下一步资料。',
    error: '提交失败',
    errorMessage: '请稍后再试。',
  },
  de: {
    ...
    successMessage: 'Unser Team meldet sich innerhalb von 24 Stunden, um Projektdetails und nächste Schritte zu bestätigen.',
  ...
  ja: {
    ...
    successMessage: '24時間以内にご連絡し、案件条件と次のステップを確認します。',
    error: '送信失敗',
  ...
  es: {
    ...
    successMessage: 'Nuestro equipo le contactará en 24 horas para confirmar detalles del proyecto y próximos pasos.',
    error: 'Envío fallido',
