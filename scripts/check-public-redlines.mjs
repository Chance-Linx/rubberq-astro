...
const blockedPatterns = [
  ...
  ['old robotics positioning should not appear in public copy', /\brobotics\b|\bRobotics\b/],
  ['old AI/data-center positioning should not appear in public copy', /\bAI\s+(?:hardware|infrastructure)\b|\bdata\s+center(?:s)?\b/i],
  ['unconfirmed EV high-voltage component examples are blocked', /\bbattery\s+pack\b|\bPDU\b|\bBMS\b/i],
